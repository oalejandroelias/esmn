...
(function ($) {
  ...
  var defaults = {
    ...
    // Agregado por Eduardo Zamora:
    // Campo required, por defecto=false
    required: false,
  ...
  $.fn.bootstrapBirthday = function (options) {
    ...
    var createHtmlSkeleton = function () {
      ...
      bsBD.$year = $("<select data-birthday=''></select>");
      ...
      bsBD.$month = $("<select data-birthday=''></select>");
      ...
      bsBD.$day = $("<select data-birthday=''></select>");
    ...
    var createHtmlWidget = function () {
      ...
      // Agregar propiedad required si fue especificada.
      if (bsBD.settings.required) {
        $("select[data-birthday='']").prop("required",true);
      }
