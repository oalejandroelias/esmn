                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-account-settings mx-1"></i> ConfiguraciÃ³n de la cuenta</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?= base_url('login/logout');?>"><i class="mdi mdi-logout mx-1"></i> Cerrar SesiÃ³n</a>
