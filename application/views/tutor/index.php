						...
						<div class="row">
							<div class="col-sm-12">
										...
										<?php foreach($tutores as $t){ ?>
											<tr>
												...
												<td>
													...
													<?php if($boton_edit){?>
														<a href="<?php echo site_url('tutor/edit/'.$t['id']); ?>" class="btn btn-info btn-sm">Editar</a>
													<?php }?>
													<?php if($boton_remove){?>
														<a href="<?php echo site_url('tutor/remove/'.$t['id']); ?>" data-confirm="remove" class="btn btn-danger btn-sm">Eliminar</a>
													<?php }?>
								...
								<div class="pull-right">
									<?php if ($boton_add): ?>
										<a href="<?php echo site_url('tutor/add'); ?>" class="btn btn-success">Nuevo</a>
									<?php endif; ?>
								</div>
							</div>
						</div>
