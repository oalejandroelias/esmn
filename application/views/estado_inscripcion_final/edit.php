<?php echo form_open('estado_inscripcion_final/edit/'.$estado_inscripcion_final['id'],array("class"=>"form-horizontal")); ?>
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nombre" required value="<?php echo ($this->input->post('nombre') ? $this->input->post('nombre') : $estado_inscripcion_final['nombre']); ?>" class="form-control" id="nombre" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nomenclatura" value="<?php echo ($this->input->post('nomenclatura') ? $this->input->post('nomenclatura') : $estado_inscripcion_final['nomenclatura']); ?>" class="form-control" id="nomenclatura" />
