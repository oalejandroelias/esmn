						...
						<div class="row">
							<div class="col-sm-12">
								<table id="zero_config" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="zero_config_info">
									...
									<tbody>
										<?php foreach($estado_inscripcion_inicial as $e){ ?>
											<tr>
												...
												<td>
													...
													<?php if($boton_edit){?>
														<a href="<?php echo site_url('estado_inscripcion_inicial/edit/'.$e['id']); ?>" class="btn btn-info btn-sm">Editar</a>
													<?php }?>
													<?php if($boton_remove){?>
														<a href="<?php echo site_url('estado_inscripcion_inicial/remove/'.$e['id']); ?>" data-confirm="remove" class="btn btn-danger btn-sm">Eliminar</a>
													<?php }?>
								...
								<div class="pull-right">
									<?php if ($boton_add): ?>
										<a href="<?php echo site_url('estado_inscripcion_inicial/add'); ?>" class="btn btn-success">Nuevo</a>
									<?php endif; ?>
								</div>
							</div>
						</div>
