		...
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nombre" required value="<?php echo ($this->input->post('nombre') ? $this->input->post('nombre') : $estado_asistencia['nombre']); ?>" class="form-control" id="nombre" />
